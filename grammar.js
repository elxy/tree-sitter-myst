// This grammar only concerns the block structure according to the Markedly Structured Text Spec
// (https://myst-parser.readthedocs.io/en/latest/syntax/syntax.html)
// For more information see README.md
//
EXTENSION_DEFAULT = !process.env.NO_DEFAULT_EXTENSIONS;
EXTENSION_GFM = process.env.EXTENSION_GFM || EXTENSION_DEFAULT;
EXTENSION_TASK_LIST = process.env.EXTENSION_TASK_LIST || EXTENSION_GFM;
EXTENSION_STRIKETHROUGH = process.env.EXTENSION_STRIKETHROUGH || EXTENSION_GFM;
EXTENSION_PIPE_TABLE = process.env.EXTENSION_PIPE_TABLE || EXTENSION_GFM;
EXTENSION_MINUS_METADATA = process.env.EXTENSION_MINUS_METADATA || EXTENSION_DEFAULT;
EXTENSION_PLUS_METADATA = process.env.EXTENSION_PLUS_METADATA || EXTENSION_DEFAULT;
...
module.exports = grammar({
    ...
    rules: {
        ...
        _list_item_content: $ => choice(
            ...
            repeat1($._block),
            EXTENSION_TASK_LIST ? prec(1, seq(
...
function html_entity_regex() {
    ...
    let html_entities = require("./entities.json");
    let s = '&(';
